...
public class LinkedListTester {
  ...
  public void testContains() {
    ...
    list.addToFront(1);
    assertEquals("Testing list of one node", true, list.contains(1));
    assertEquals("Testing list of one node", false, list.contains(3));
    list.addToFront(3);
    list.addToFront(2);  
    assertEquals("Testing list of three nodes", true, list.contains(1));
    assertEquals("Testing list of three nodes", false, list.contains(5));
  }
